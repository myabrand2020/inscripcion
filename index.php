...
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-EVSTQN3/azprG1Anm3QDgpJLIm9Nao0Yz1ztcQTwFspd3yD65VohhpuuCOmLASjC" crossorigin="anonymous">
 ...
 <br>
  ...
  <div class="card-body text-warning">
    ...
    <p class="card-text">Apreciados aspirantes seleccione su programa de interes.</p>
  </div>
<form action=""method="post">
<div class="form">
<div class="row">
<div class="col-6">
<label>fecha Incripcion</label>
...
<label>Mail</label>
<input type="text" name="mail" placeholder="abcdf@abcd.com" class="form-control"><br>
<label>Telefono:</label>
<input type="number" name="tel" placeholder="Numero" class="form-control"><br>
<label>Solicitud</label>
<select name="solicitud" class="form-control">
<option>--- seleccione---</option>
<option>Incripcion</option>
<option>Matricula</option>
</select><br>
</div>
</div>
</div>
<center><input type="submit" class="btn btn-warning" name="btn_guardar" value="Guardar"></center><br>

<center><input type="submit" class="btn btn-primary" name="btn_consulta" value="Consultar">

<input type="submit" class="btn btn-dark" name="btn_modificar" value="Actualizar">

<input type="submit" class="btn btn-danger" name="btn_eliminar" value="Eliminar"></center><br>
...
location.href = '../inscripcion/index.php';</script>";
       ...
       Programa, Sede, Mail, Telefono, Solicitud) value ('$fecha','$nombres', '$apellidos', '$tipo', '$numero',
 ...
 if (isset($_POST['btn_consulta']))
{
    ...
    
 {
    ...
    <table width=\"30%\"border=\"1\">
     ...
     <td><center><b>Programa</b></center></td>
     <td><center><b>Sede</b></center></td>
    ...
    <td><center>".$consulta['Programa']."</center></td>
    <td><center>".$consulta['Sede']."</center></td>
    ...
    {   $existe=0;
           ...
           if($existe==0)
     {
       ...
       Solicitud = '$_POST[solicitud]'
         ...
         echo "<script> alert('Datos de usuario se ha modificado y actualizado en la BD');
         location.href = '../inscripcion/index.php';</script>";
  ...
  { 
    echo "<script> alert ('El campo de documento es obligatorio');
     ...
     else
     {
      ...
      $resultado = mysqli_query($conectar, "SELECT * FROM datos WHERE Numero_documento = '$referencia'");
      while($consulta=mysqli_fetch_array($resultado))
      ...
      {
        echo "<script> alert ('El numero de documento ingresado no existe en nuestra BD');
        location.href = '../inscripcion/index.php';</script>";
      }
        else
       {
        $eliminar = " DELETE FROM datos WHERENumero_documento = '$referencia";
        mysqli_query($conectar, $eliminar);
        echo "<script> alert ('Los registros de este numero de documento han sido eliminados en nuestra BD');
        location.href = '../inscripcion/index.php';</script>";
